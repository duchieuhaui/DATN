    ...
    <div id="sidebar" class="navbar-expand-lg navbar-expand-lg-collapse-block collapse">
        ...
        <form action="<?php echo e(url(app_get_locale(false,false,'/').config('flight.flight_route_prefix'))); ?>" class="bravo_form_filter">
            ...
            <div class="sidenav border border-color-8 rounded-xs">
                                ...
                                <?php for($number = 5 ;$number >= 2 ; $number--): ?>
                                    <div class="form-group font-size-14 text-lh-md text-secondary mb-3">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" id="review_score_<?php echo e($number); ?>" name="review_score[]" type="checkbox" value="<?php echo e($number); ?>" <?php if(  in_array($number , request()->query('review_score',[])) ): ?>  checked <?php endif; ?>>
                                            <label class="custom-control-label text-lh-inherit text-color-1" for="review_score_<?php echo e($number); ?>">
                ...
                <?php if(!empty($flight_min_max_price)): ?>
                                        ...
                                        <?php $__currentLoopData = $item->terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($key <= 2 ): ?>
                                                ...
                                                <div class="form-group d-flex align-items-center justify-content-between font-size-1 text-lh-md text-secondary mb-3">
                                                    ...
                                                    <span><?php echo e($term->flight_count??0); ?></span>
                                                </div>
                                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Flight/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>