<div class="item filter-item">
    <?php if(setting_item('tour_location_search_style')=='autocompletePlace'): ?>
        <div class="mb-0">
        ...
        <div class="mb-0">
            <div class="input-group border-bottom border-width-2 border-color-1">
                ...
                <div class="smart-search border-0 p-0 form-control  height-40">
                    <input type="text" class="smart-search-location parent_text  font-weight-bold font-size-16 shadow-none hero-form font-weight-bold border-0 p-0" <?php echo e(( empty(setting_item("tour_location_search_style")) or setting_item("tour_location_search_style") == "normal" ) ? "readonly" : ""); ?> placeholder="<?php echo e(__("Where are you going?")); ?>" value="<?php echo e($location_name); ?>" data-onLoad="<?php echo e(__("Loading...")); ?>"
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Tour/Views/frontend/layouts/search-map/fields/location.blade.php ENDPATH**/ ?>