                ...
                <?php if(is_enable_guest_checkout()): ?>
                    <div class="col-12 d-none" id="confirmRegisterContent">
                        <div class="row">
                            <div class="col-sm-6" >
                                <div class="form-group ">
                                    <label class="form-label" ><?php echo e(__("Password")); ?> <span class="required">*</span></label>
                                    <input type="password" class="form-control" name="password" autocomplete="off" >
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group ">
                                    <label class="form-label" ><?php echo e(__('Password confirmation')); ?> <span class="required">*</span></label>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Booking/Views/frontend/booking/checkout-form.blade.php ENDPATH**/ ?>