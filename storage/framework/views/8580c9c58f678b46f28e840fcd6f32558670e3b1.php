...
?>
<div class="card item-loop-wrap transition-3d-hover shadow-hover-2 item-loop w-100 <?php echo e($wrap_class ?? ''); ?>">
    ...
    <div class="card-body p-0 mx-3 my-3 border-bottom">
    ...
    <div class="mx-3 mt-3 mb-2 type-attribute">
        <div class="row">
            <div class="col-6">
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Car/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>