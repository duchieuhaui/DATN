<div class="sidebar border border-color-1 rounded-xs">
    <div class="p-4 mb-1">
        <form action="<?php echo e(route("space.search")); ?>" class="bravo_form" method="get">
            <?php $search_fields = setting_item_array('space_search_fields');
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Space/Views/frontend/layouts/search/form-search-vertical.blade.php ENDPATH**/ ?>