<?php if(is_default_lang()): ?>
                ...
                <div class="form-controls">
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            ...
                            ?>
                            <?php $__currentLoopData = $event_map_search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="item" data-number="<?php echo e($key); ?>">
                                    <div class="row">
                                        <div class="col-md-7">
                                            <select name="event_map_search_fields[<?php echo e($key); ?>][field]" class="custom-select">
                                            ...
                                            <br>
                                            <select name="event_map_search_fields[<?php echo e($key); ?>][attr]" class="mt-2 custom-select">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="event_map_search_fields[<?php echo e($key); ?>][position]" min="0" value="<?php echo e($item['position'] ?? 0); ?>" class="form-control">
                                        </div>
                                        <div class="col-md-1">
    ...
    <hr>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Event/Views/admin/settings/map-search.blade.php ENDPATH**/ ?>