...
>
    <div class="all-block-header flex-shrink-0 shadow-sm">
        <h5 @click="showAddBlock = false" class="modal-title font-weight-medium text-center px-3 py-2 d-flex align-items-center flex-shrink-0">
            ...
            <?php echo e(__("ADD LAYER")); ?>

        </h5>
    </div>
    <div class="p-2 flex-grow-1 overflow-auto">
        <input type="text" v-model="s" placeholder="<?php echo e(__("Search block ...")); ?>" class="form-control mb-2">
        <hr>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Template/Views/admin/live/parts/add-block.blade.php ENDPATH**/ ?>