<div class="form-group-item">
    ...
    <div class="g-items">
        <?php if(!empty($translation->include)): ?>
            <?php if(!is_array($translation->include)) $translation->include = json_decode( old('include',$translation->include)); ?>
...
<div class="form-group-item">
    ...
    <div class="g-items">
        <?php if(!empty($translation->exclude)): ?>
            <?php if(!is_array($translation->exclude)) $translation->exclude = json_decode( old('exclude',$translation->exclude) ); ?>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Tour/Views/admin/tour/include-exclude.blade.php ENDPATH**/ ?>