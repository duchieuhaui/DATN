        ...
        <div id="bravo_car_book_app" class="bravo_single_book " v-cloak>
            <div class="border border-color-7 rounded mb-5">
                ...
                <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                    <div class="p-4">
                        <span class="d-block text-gray-1 font-weight-normal mb-0 text-left"><?php echo e(__("Pick Up Date")); ?></span>
                        <div class="mb-4">
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Car/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>