        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group" data-condition="facebook_enable:is(1)">
                    ...
                    <div class="form-controls">
                        <input type="text" name="facebook_client_secret" value="<?php echo e(setting_item('facebook_client_secret')); ?>" class="form-control">
                    </div>
                </div>
            </div>
        </div>
...
<hr>
<?php echo $__env->make('Core::admin.settings.groups.parts.cookie-consent-setting', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Core/Views/admin/settings/groups/advance.blade.php ENDPATH**/ ?>