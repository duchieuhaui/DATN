...
<div class="card transition-3d-hover shadow-hover-2 item-loop h-100 <?php echo e($wrap_class ?? ''); ?>">
    ...
    <div class="card-body px-3 py-2">
        ...
        <?php endif; ?>
        <a <?php if(!empty($blank)): ?> target="_blank" <?php endif; ?> href="<?php echo e($row->getDetailUrl($include_param ?? true)); ?>" class="card-title font-size-17 font-weight-bold mb-0 text-dark">
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Tour/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>