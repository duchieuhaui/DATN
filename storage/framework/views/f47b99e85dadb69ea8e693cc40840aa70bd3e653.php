<div class="bravo-list-tour product-card-block product-card-v2 border-bottom border-color-8">
    <div class="container space-1">
        <?php if(!empty($title)): ?>
            <div class="d-flex justify-content-between mb-3 pt-md-3 mt-1 pb-md-3 mb-md-2 align-items-end">
                ...
                <a href="<?php echo e(route("tour.search")); ?>" class="font-weight-bold d-flex text-lh-1 mb-md-2 ml-2"><?php echo e(__("More")); ?>
...
</div><?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Tour/Views/frontend/blocks/list-tour/style_1.blade.php ENDPATH**/ ?>