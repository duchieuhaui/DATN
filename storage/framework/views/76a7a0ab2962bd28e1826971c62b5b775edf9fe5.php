...
<div class="owner-info widget-box">
    <div class="media">
        ...
        <div class="media-body">
            ...
            <?php if((!Auth::id() or Auth::id() != $row->author_id ) and setting_item('inbox_enable')): ?>
                <a class="btn btn-sm btn-primary" href="<?php echo e(route('user.chat',['user_id'=>$row->author_id])); ?>" ><i class="icon ion-ios-chatboxes"></i> <?php echo e(__('Message host')); ?></a>
            <?php endif; ?>
        </div>
    </div>
</div>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Tour/Views/frontend/layouts/details/vendor.blade.php ENDPATH**/ ?>