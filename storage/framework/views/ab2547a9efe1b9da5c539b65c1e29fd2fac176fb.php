<div class="bravo_filter navbar-expand-lg navbar-expand-lg-collapse-block">
    ...
    <div id="sidebar" class="navbar-expand-lg navbar-expand-lg-collapse-block collapse">
        ...
        <div class="item pb-4 mb-2">
            <?php echo $__env->make('Boat::frontend.layouts.search.form-search-vertical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        
        <div class="item pb-4 mb-2">
            <a href="<?php echo e(route("boat.search",['_layout'=>'map'])); ?>" class="d-block border border-color-1 rounded-xs">
                <img src="<?php echo e(url("/themes/mytravel/images/map.jpg")); ?>" alt="" width="100%">
            </a>
        </div>
        <form action="<?php echo e(url(app_get_locale(false,false,'/').config('boat.boat_route_prefix'))); ?>" class="bravo_form_filter">
            ...
            <div class="sidenav border border-color-8 rounded-xs">
                ...
                <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(empty($item['hide_in_filter_search'])): ?>
                        ...
                        <div id="attr_<?php echo e($item->id); ?>" class="accordion rounded-0 shadow-none border-top">
                            <div class="border-0">
                                        ...
                                        <?php $__currentLoopData = $item->terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($key <= 2 ): ?>
                                                ...
                                                <div class="form-group d-flex align-items-center justify-content-between font-size-1 text-lh-md text-secondary mb-3">
                                                    ...
                                                    <span><?php echo e($term->boat_count??0); ?></span>
                                                </div>
                                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Boat/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>