<div class="bravo_filter navbar-expand-lg navbar-expand-lg-collapse-block">
    ...
    <div id="sidebar" class="navbar-expand-lg navbar-expand-lg-collapse-block collapse">
        ...
        <div class="item pb-4 mb-2">
            <?php echo $__env->make('Hotel::frontend.layouts.search.form-search-vertical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        
        <div class="item pb-4 mb-2">
            <a href="<?php echo e(route("hotel.search",['_layout'=>'map'])); ?>" class="d-block border border-color-1 rounded-xs">
                <img src="<?php echo e(url("themes/mytravel/images/map.jpg")); ?>" alt="" width="100%">
            </a>
        </div>
        <form action="<?php echo e(url(app_get_locale(false,false,'/').config('hotel.hotel_route_prefix'))); ?>" class="bravo_form_filter">
                        ...
                        <div class="card-collapse">
                            <h3 class="mb-0">
                                <button type="button" class="btn btn-link btn-block card-btn py-2  text-lh-3 collapsed" data-toggle="collapse" data-target="#rate">
                                    <span class="row align-items-center">
                                        <span class="col-9">
                                            <span class="d-block font-size-lg-15 font-size-17 font-weight-bold text-dark text-lh-1dot4"><?php echo e(__("Hotel Star")); ?></span>
                                        </span>
                                        <span class="col-3 text-right">
                                            <span class="card-btn-arrow">
                                                <span class="fa fa-chevron-down small"></span>
                                ...
                                <?php for($number = 5 ;$number >= 2 ; $number--): ?>
                                    <div class="form-group font-size-14 text-lh-md text-secondary mb-3">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" id="star_rate<?php echo e($number); ?>" name="star_rate[]" type="checkbox" value="<?php echo e($number); ?>" <?php if(  in_array($number , request()->query('star_rate',[])) ): ?>  checked <?php endif; ?>>
                                            <label class="custom-control-label text-lh-inherit text-color-1" for="star_rate<?php echo e($number); ?>">
                                                <div class="d-inline-flex align-items-center font-size-13 text-lh-1 text-primary">
                                                    <div class="green-lighter ml-1 letter-spacing-2">
                                                        <?php for($star_rate = 1 ;$star_rate <= $number ; $star_rate++): ?>
                                        ...
                                        <?php $__currentLoopData = $item->terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($key <= 2 ): ?>
                                                ...
                                                <div class="form-group d-flex align-items-center justify-content-between font-size-1 text-lh-md text-secondary mb-3">
                                                    ...
                                                    <span><?php echo e($term->hotel_count??0); ?></span>
                                                </div>
                                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Hotel/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>