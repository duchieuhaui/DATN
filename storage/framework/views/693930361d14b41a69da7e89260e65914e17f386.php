<div class="row">
    ...
    <div class="col-sm-8">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <input type="text" name="style_main_color" value="<?php echo e(setting_item('style_main_color','#5191FA')); ?>" class="has-colorpicker d-none">
                    </div>
                </div>
                <?php endif; ?>
                <div class="form-group">
        ...
        <div class="panel">
            <div class="panel-title"><strong><?php echo e(__('H1,H2,H3 Options')); ?></strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <label><?php echo e(__("H1 Font Family")); ?></label>
                    <div class="form-controls">
                        <input placeholder='"Poppins"' type="text" name="style_h1_font_family" value="<?php echo e(setting_item_with_lang('style_h1_font_family',request()->query('lang'))); ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label><?php echo e(__("H2 Font Family")); ?></label>
                    <div class="form-controls">
                        <input placeholder='"Poppins"' type="text" name="style_h2_font_family" value="<?php echo e(setting_item_with_lang('style_h2_font_family',request()->query('lang'))); ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label><?php echo e(__("H3 Font Family")); ?></label>
                    <div class="form-controls">
                        <input placeholder='"Poppins"' type="text" name="style_h3_font_family" value="<?php echo e(setting_item_with_lang('style_h3_font_family',request()->query('lang'))); ?>" class="form-control">
                    </div>
                </div>
            </div>
        </div>
    </div>
</div><?php do_action(\Modules\Core\Hook::STYLE_SETTING_AFTER_GENERAL_STYLE) ?>
<?php if(is_default_lang()): ?>
    <hr>
    <div class="row">
        <div class="col-sm-4">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Core/Views/admin/settings/groups/style.blade.php ENDPATH**/ ?>