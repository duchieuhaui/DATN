    ...
    <div class="container-fluid">
        ...
        <div class="text-right">
            <div class="header-status-control">
                <a href="<?php echo e(route('review.admin.index')); ?>"><?php echo e(__("All Reviews")); ?>

                    <span>(<?php echo e(\Modules\Review\Models\Review::countReviewByStatus()); ?>)</span> </a> -
                <a href="<?php echo e(route('review.admin.index',['status'=>'approved'])); ?>"><?php echo e(__("Approved")); ?>

                    <span>(<?php echo e(\Modules\Review\Models\Review::countReviewByStatus("approved")); ?>)</span></a> -
                <a href="<?php echo e(route('review.admin.index',['status'=>'pending'])); ?>"><?php echo e(__("Pending")); ?>
                ...
                <a href="<?php echo e(route('review.admin.index',['status'=>'trash'])); ?>"><?php echo e(__("Trash")); ?>
                                ...
                                <tr class="<?php echo e($row->status); ?>">
                                    ...
                                    <td>
                                        <?php if(!empty( $metaUser =  $row->author)): ?>
                                            <a href="<?php echo e(route('review.admin.index',['customer_id'=>$metaUser->id])); ?>"><?php echo e($metaUser->email ?? 'Email'); ?></a>
                                            <p>
                                                <a href="<?php echo e(route("review.admin.index",['s'=>$row->author_ip])); ?>"><?php echo e($row->author_ip); ?></a>
                                            </p>
                                        <?php else: ?>
                                        ...
                                        <?php if(!empty($metaReviews = $row->getReviewMetaPicture())): ?>
                                            ...
                                            <div class="review_list_photos d-flex mt-3">
                                                <?php $__currentLoopData = $listImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oneImages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="review_upload_item" style="background-image: url(<?php echo e(@$imagesData['download']); ?>); background-repeat: no-repeat; background-size: cover; background-position: center; height: 100px;width: 100px;margin-right: 10px;"></div>
                                    ...
                                    <td>
                                        <?php if(!empty($service)): ?>
                                            <a href="<?php echo e(route('review.admin.index',['service'=>$service->getModelName()])); ?>" class="badge badge-dark"><?php echo e($service->getModelName()); ?></a>
                                        <?php else: ?>
                                            <?php echo e(__("[Deleted]")); ?>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('review.admin.index',['status'=>$row->status])); ?>" class="badge badge-<?php echo e($row->status); ?>"><?php echo e($row->status); ?></a>
                                    </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Review/Views/admin/index.blade.php ENDPATH**/ ?>