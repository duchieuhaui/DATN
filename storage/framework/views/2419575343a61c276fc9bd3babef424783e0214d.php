    ...
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                ...
                <?php do_action(\Modules\Vendor\Hook::VENDOR_SETTING_AFTER_GENERAL) ?>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Vendor/Views/admin/settings/vendor.blade.php ENDPATH**/ ?>