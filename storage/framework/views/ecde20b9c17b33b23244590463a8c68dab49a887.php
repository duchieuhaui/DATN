...
<?php $__env->startSection('content'); ?>
                                ...
                                <div slot-scope="{node,index, path, tree}" class="nestable-item-content" >
                                    ...
                                    <div class="menu-info" v-show="node._open">
                                        ...
                                        <div class="mega-group">
                                            <div class="form-group">
                                                <input type="checkbox" v-model="node.mega_menu" :id="'mega-menu-' + path"> <label :for="'mega-menu-' + path"><?php echo e(__('Enable mega menu')); ?></label>
                                            </div>
                                            <div class="form-group" v-show="node.mega_menu">
                                                <label><?php echo e(__('Columns')); ?></label>
                                            ...
                                            <div class="form-group" v-show="node.mega_menu">
                                                <label><?php echo e(__('Mega image url')); ?></label>
                                                <input type="text" v-model="node.mega_image_url" class="form-control input-sm">
                                            </div>
                                        </div>

                                        <?php do_action(\Modules\Core\Hook::MENU_ITEM_SETTING_MORE) ?>
    ...
    <script>
        ...
        var current_menu_lang = '<?php echo e(request()->query('lang','')); ?>';
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Core/Views/admin/menu/detail.blade.php ENDPATH**/ ?>