<div class="row">
    <div class="col-lg-3 col-md-12">
        <?php echo $__env->make('Boat::frontend.layouts.search.filter-search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
        ...
        <div class="bravo-list-item">
            <div class="d-flex justify-content-between align-items-center mb-4 topbar-search">
                <h3 class="font-size-21 font-weight-bold mb-0 text-lh-1 result-count">
                    <?php if($rows->total() > 1): ?>
                        <?php echo e(__(":count boats found",['count'=>$rows->total()])); ?>

                    <?php else: ?>
                        <?php echo e(__(":count boat found",['count'=>$rows->total()])); ?>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Boat/Views/frontend/layouts/search/list-item.blade.php ENDPATH**/ ?>