<div class="sidebar border border-color-1 rounded-xs">
    <div class="p-4 mb-1">
        <form action="<?php echo e(route("car.search")); ?>" class="bravo_form" method="get">
            ...
            <?php if(!empty($search_fields)): ?>
                <?php $__currentLoopData = $search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php switch($field['field']):
                        ...
                        <?php break; ?>
                        <?php case ('guests'): ?>
                          <?php echo $__env->make('Car::frontend.layouts.search.fields.guests', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php break; ?>
                    <?php endswitch; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
            <div class="text-center">
                <button type="submit" class="btn btn-primary height-60 w-100 font-weight-bold mb-xl-0 mb-lg-1 transition-3d-hover"><i class="flaticon-magnifying-glass mr-2 font-size-17"></i><?php echo e(__('Search')); ?></button>
            </div>
        </form>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Car/Views/frontend/layouts/search/form-search-vertical.blade.php ENDPATH**/ ?>