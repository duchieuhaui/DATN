    ...
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                ...
                <?php do_action(\Modules\Booking\Hook::BOOKING_SETTING_AFTER_TERM, $settings) ?>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Booking/Views/admin/settings/booking.blade.php ENDPATH**/ ?>