        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <select name="space_layout_search" class="form-control" >
                            <?php $__currentLoopData = config('space.layouts',['normal'=>__("Normal Layout"),'map'=>__("Map Layout")]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>)
                                <option value="<?php echo e($id); ?>" <?php echo e(setting_item('space_layout_search','normal') == $id ? 'selected' : ''); ?>><?php echo e($name); ?></option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                <input type="number" min="1" name="space_page_limit_item" placeholder="<?php echo e(__("Default: 9")); ?>" value="<?php echo e(setting_item_with_lang('space_page_limit_item',request()->query('lang'), 9)); ?>" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3" data-condition="space_location_search_style:is(autocompletePlace)">
                        ...
                        <div class="input-group mb-3">
                            <input type="number" name="space_location_radius_value" min="0" value="<?php echo e(setting_item('space_location_radius_value',1)); ?>" class="form-control" >
                            <div class="input-group-append">
                                <select name="space_location_radius_type" id="">
                                    <option  <?php echo e((setting_item('space_location_radius_type') ?? '') == 3959 ? 'selected' : ''); ?> value="3959"><?php echo e(__('Miles')); ?></option>
                                    <option  <?php echo e((setting_item('space_location_radius_type') ?? '') == 6371 ? 'selected' : ''); ?> value="6371"><?php echo e(__('Km')); ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <select name="space_layout_map_option" class="form-control">
                            <option <?php echo e((setting_item_with_lang('space_layout_map_option',request()->query('lang')) ?? '') == 'map_left' ? 'selected' : ''); ?> value="map_left"><?php echo e(__('Map Left')); ?></option>
                            <option <?php echo e((setting_item_with_lang('space_layout_map_option',request()->query('lang')) ?? '') == 'map_right' ? 'selected' : ''); ?> value="map_right"><?php echo e(__("Map Right")); ?></option>
                        </select>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-controls">
                            <input type="text" name="space_map_lat_default" value="<?php echo e($settings['space_map_lat_default'] ?? ''); ?>" class="form-control" placeholder="21.030513">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <label><?php echo e(__("Map Lng Default")); ?></label>
                        <div class="form-controls">
                            <input type="text" name="space_map_lng_default" value="<?php echo e($settings['space_map_lng_default'] ?? ''); ?>" class="form-control" placeholder="105.840565">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <label><?php echo e(__("Map Zoom Default")); ?></label>
                        <div class="form-controls">
                            <input type="text" name="space_map_zoom_default" value="<?php echo e($settings['space_map_zoom_default'] ?? ''); ?>" class="form-control" placeholder="13">
                        </div>
                    </div>
                ...
                <div class="form-group mt-3">
                    ...
                    <div class="form-controls form-group-image">
                        <?php echo \Modules\Media\Helpers\FileHelper::fieldUpload('space_icon_marker_map',$settings['space_icon_marker_map'] ?? ""); ?>

                    </div>
                </div>
                <?php do_action(\Modules\Space\Hook::SPACE_SETTING_AFTER_MAP) ?>
                <?php endif; ?>
            </div>
        </div>
...
<?php if(is_default_lang()): ?>
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc"><?php echo e(__('Config Booking for space')); ?></p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <select name="space_booking_type" class="form-control">
                                    <option value="by_day" <?php echo e(($settings['space_booking_type'] ?? '') == 'by_day' ? 'selected' : ''); ?>> <?php echo e(__("Space by day")); ?></option>
                                    <option value="by_night" <?php echo e(($settings['space_booking_type'] ?? '') == 'by_night' ? 'selected' : ''); ?>> <?php echo e(__("Space by night")); ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_allow_vendor_can_change_paid_amount" value="1" <?php if(!empty($settings['space_allow_vendor_can_change_paid_amount'])): ?> checked <?php endif; ?> /> <?php echo e(__("Yes please")); ?> </label>
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_allow_vendor_can_add_service_fee" value="1" <?php if(!empty($settings['space_allow_vendor_can_add_service_fee'])): ?> checked <?php endif; ?> /> <?php echo e(__("Yes please")); ?> </label>
                            <br>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Space/Views/admin/settings/space.blade.php ENDPATH**/ ?>