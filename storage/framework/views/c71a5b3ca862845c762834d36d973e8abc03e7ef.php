            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="price" class="form-control" value="<?php echo e(old('price',$row->price)); ?>" placeholder="<?php echo e(__("Tour Price")); ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label"><?php echo e(__("Sale Price")); ?></label>
                        <input type="text" name="sale_price" class="form-control" value="<?php echo e(old('sale_price',$row->sale_price)); ?>" placeholder="<?php echo e(__("Tour Sale Price")); ?>">
                    </div>
                </div>
                <div class="col-lg-12">
                    <span>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Tour/Views/admin/tour/pricing.blade.php ENDPATH**/ ?>