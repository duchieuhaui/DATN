                                ...
                                <div class="item" data-number="<?php echo e($key); ?>">
                                    <div class="row">
                                        <div class="col-md-7">
                                            ...
                                            <br>
                                            <select name="space_search_fields[<?php echo e($key); ?>][attr]" class="mt-2 custom-select">
                                    ...
                                    <div class="col-md-7">
                                        <?php if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale')): ?>
                                            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="g-lang">
                                                    <div class="title-lang"><?php echo e($language->name); ?></div>
                                                    <input type="text" __name__="space_search_fields[__number__][title<?php echo e($key_lang); ?>]" class="form-control">
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            <input type="text" __name__="space_search_fields[__number__][title]"  class="form-control">
                                        <?php endif; ?>
                                        ...
                                        <br>
                                        <select __name__="space_search_fields[__number__][attr]" class="mt-2 custom-select">
                                            <option value=""><?php echo e(__("-- Select Attribute --")); ?></option>
                                            <?php $__currentLoopData = $attrs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Space/Views/admin/settings/form-search.blade.php ENDPATH**/ ?>