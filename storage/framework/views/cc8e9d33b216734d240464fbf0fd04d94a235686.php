        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        <?php if(!empty($rows)): ?>
                            <form method="post" action="<?php echo e(route('user.admin.subscriber.bulkEdit')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
                    ...
                    <div class="col-left">
                        <form method="get" action="<?php echo e(route('user.admin.subscriber.index')); ?> " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            <a class="btn btn-warning btn-icon" href="<?php echo e(route('user.admin.subscriber.export')); ?>" target="_blank" title="<?php echo e(__("Export to excel")); ?>"><i class="icon ion-md-cloud-download"></i>&nbsp;<?php echo e(__
                            ('Export')); ?>
                            ...
                            <table class="table table-hover">
                                ...
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="title">
                                            <a href="<?php echo e(route('user.admin.subscriber.edit',['id'=>$row->id])); ?>"><?php echo e($row->email); ?></a>
                                        </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/User/Views/newsletter/subscriber/index.blade.php ENDPATH**/ ?>