...
<div class="card transition-3d-hover shadow-hover-2 mt-2 item-loop <?php echo e($wrap_class ?? ''); ?>">
    <div class="position-relative">
        <a <?php if(!empty($blank)): ?> target="_blank" <?php endif; ?> href="<?php echo e($row->getDetailUrl(false)); ?>" class="d-block gradient-overlay-half-bg-gradient-v5">
    ...
    <div class="card-body px-4 pt-2 pb-3">
        ...
        <?php endif; ?>
        <a <?php if(!empty($blank)): ?> target="_blank" <?php endif; ?> href="<?php echo e($row->getDetailUrl(false)); ?>" class="card-title font-size-17 font-weight-medium text-dark"><?php echo e($translation->title); ?></a>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Hotel/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>