...
>
    ...
    <div class="flex-shrink-0 p-2 border-top-1">
        <a href="#" class="btn btn-info btn-block" @click.prevent="showAddBlock = true"><i class="fa fa-plus"></i> <?php echo e(__("Add layer")); ?></a>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Template/Views/admin/live/parts/layers.blade.php ENDPATH**/ ?>