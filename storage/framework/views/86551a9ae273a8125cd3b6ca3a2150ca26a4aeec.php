...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(!empty($recovery) ? __('Recovery') : __("All Cars")); ?></h1>
            <div class="title-actions">
                <?php if(empty($recovery)): ?>
                <a href="<?php echo e(route('car.admin.create')); ?>" class="btn btn-primary"><?php echo e(__("Add new car")); ?></a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                <?php if(!empty($rows)): ?>
                    <form method="post" action="<?php echo e(route('car.admin.bulkEdit')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
            ...
            <div class="col-left dropdown">
                <form method="get" action="<?php echo e(!empty($recovery) ? route('car.admin.recovery') : route('car.admin.index')); ?>" class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
                    <?php if(!empty($rows) and $car_manage_others): ?>
            ...
            <div class="panel-body">
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                            ...
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="<?php echo e($row->status); ?>">
                                    ...
                                    <td class="title">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('car.admin.edit',['id'=>$row->id])); ?>"><?php echo e($row->title); ?></a>
                                    </td>
                                    ...
                                    <td>
                                        <?php if(empty($recovery)): ?>
                                            <a href="<?php echo e(route('car.admin.edit',['id'=>$row->id])); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> <?php echo e(__('Edit')); ?></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7"><?php echo e(__("No car found")); ?></td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Car/Views/admin/index.blade.php ENDPATH**/ ?>