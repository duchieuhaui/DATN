        ...
        <div class="bravo_search_map <?php echo e(setting_item_with_lang("tour_layout_map_option",false,"map_left")); ?>">
            ...
            <div class="results_item">
                ...
                <div class="listing_items ajax-search-result">
                    <?php echo $__env->make('Tour::frontend.ajax.search-result-map', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app',['container_class'=>'container-fluid'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Tour/Views/frontend/search-map.blade.php ENDPATH**/ ?>