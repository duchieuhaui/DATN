                ...
                <div class="card border-0 mb-3">
                    ...
                    <div id="itinerary_<?php echo e($key); ?>" class="collapse <?php if($key == 0 ): ?> show <?php endif; ?>" data-parent="#itinerary">
                        <div class="card-body">
                            ...
                            <img src="<?php echo e(!empty($item['image_id']) ? get_file_url($item['image_id'],"full") : ""); ?>" alt="<?php echo e($item['desc']); ?>" class="rounded-4">
                        </div>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Tour/Views/frontend/layouts/details/tour-itinerary.blade.php ENDPATH**/ ?>