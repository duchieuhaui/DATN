...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('user.admin.changepass',['id'=>$row->id])); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="container">
                ...
                <div class="col-md-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <?php if($row->id and $row->id != $currentUser->id and !$currentUser->hasPermission('user_update') ): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/User/Views/admin/password.blade.php ENDPATH**/ ?>