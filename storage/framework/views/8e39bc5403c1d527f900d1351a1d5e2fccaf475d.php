        ...
        <div id="bravo_space_book_app" class="bravo_single_book " v-cloak>
            <div class="border border-color-7 rounded mb-5">
                ...
                <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                    <div class="p-4">
                        <span class="d-block text-gray-1 font-weight-normal mb-0 text-left"><?php echo e(__("Check In - Out")); ?></span>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <div class="border-bottom border-width-2 border-color-1 pb-3">
                                <div class="flex-center-between mb-1 text-dark font-weight-bold">
                                    <span class="d-block">
                                        <?php echo e(__('Adults')); ?> <br>
                                        <small><?php echo e(__('Ages 12+')); ?></small>
                                    </span>
                        ...
                        <div class="mb-4">
                            <div class="border-bottom border-width-2 border-color-1 pb-3">
                                <div class="flex-center-between mb-1 text-dark font-weight-bold">
                                    <span class="d-block">
                                        <?php echo e(__('Children')); ?> <br>
                                        <small><?php echo e(__('Ages 2–12')); ?></small>
                                    </span>
                                    <div class="flex-horizontal-center">
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Space/Views/frontend/layouts/details/space-form-book.blade.php ENDPATH**/ ?>