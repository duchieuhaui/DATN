                ...
                <div class="form-controls">
                    <div class="form-group-item">
                        ...
                        <div class="g-items">
                            ...
                            ?>
                            <?php $__currentLoopData = $event_search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="item" data-number="<?php echo e($key); ?>">
                                    <div class="row">
                                        <div class="col-md-7">
                                            <?php if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale')): ?>
                                                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="g-lang">
                                                        ...
                                                        <input type="text" name="event_search_fields[<?php echo e($key); ?>][title<?php echo e($key_lang); ?>]" value="<?php echo e($item['title'.$key_lang] ?? ''); ?>" class="form-control">
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php else: ?>
                                                <input type="text" name="event_search_fields[<?php echo e($key); ?>][title]" value="<?php echo e($item['title']); ?>" class="form-control">
                                            <?php endif; ?>
                                            <select name="event_search_fields[<?php echo e($key); ?>][field]" class="custom-select">
                                            ...
                                            <br>
                                            <select name="event_search_fields[<?php echo e($key); ?>][attr]" class="mt-2 custom-select">
                                            ...
                                            <br>
                                            <select name="event_search_fields[<?php echo e($key); ?>][size]" class="mt-2 custom-select">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="event_search_fields[<?php echo e($key); ?>][position]" min="0" value="<?php echo e($item['position'] ?? 0); ?>" class="form-control">
                                        </div>
                                        <div class="col-md-1">
                                    ...
                                    <div class="col-md-7">
                                        <?php if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale')): ?>
                                            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="g-lang">
                                                    <div class="title-lang"><?php echo e($language->name); ?></div>
                                                    <input type="text" __name__="event_search_fields[__number__][title<?php echo e($key_lang); ?>]" class="form-control">
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\modules/Event/Views/admin/settings/form-search.blade.php ENDPATH**/ ?>