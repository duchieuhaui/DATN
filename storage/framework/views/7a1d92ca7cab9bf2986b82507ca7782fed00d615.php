<div class="card w-100 shadow-hover-3 mb-5 <?php echo e($wrap_class ?? ''); ?>">
	<a href="#" class="d-block mb-0 px-1 pt-1 m-3" tabindex="0">

		<img class="card-img-top" src="<?php echo e($row->airline->image_url); ?>" alt="<?php echo e($row->airline->name); ?>">
	</a>
	<div class="card-body mx-3 mt-0 mb-3 py-0 px-1">
		<div class="row">
			<div class="col-7">
	...
	<div class="mb-3">
		...
		<div class="d-flex justify-content-center mx-3">
			<?php if($row->can_book): ?>
			<a data-id="<?php echo e($row->id); ?>" href=""  onclick="event.preventDefault()" class="btn btn-blue-1 font-size-14 width-260 text-lh-lg transition-3d-hover py-1 btn-choose-flight"><?php echo e(__("Choose")); ?></a>
			<?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Flight/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>