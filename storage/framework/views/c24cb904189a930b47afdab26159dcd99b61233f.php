<div class="d-block d-md-flex flex-center-between align-items-start mb-3">
    ...
    <ul class="list-group list-group-horizontal custom-social-share">
        ...
        <li class="list-group-item px-1 border-0 dropdown">
            <a id="shareDropdownInvoker<?php echo e($row->id); ?>" class="dropdown-nav-link dropdown-toggle d-flex height-45 width-45 border rounded border-width-2 flex-content-center" href="javascript:;" role="button" aria-controls="shareDropdown<?php echo e($row->id); ?>" aria-haspopup="true" aria-expanded="false" data-unfold-event="hover" data-unfold-target="#shareDropdown<?php echo e($row->id); ?>" data-unfold-type="css-animation" data-unfold-duration="300" data-unfold-delay="300" data-unfold-hide-on-scroll="true" data-unfold-animation-in="slideInUp" data-unfold-animation-out="fadeOut" data-toggle="dropdown">
...
<?php /**PATH C:\xampp\htdocs\mytravel.2.4.0\themes/Mytravel/Tour/Views/frontend/layouts/details/tour-detail.blade.php ENDPATH**/ ?>